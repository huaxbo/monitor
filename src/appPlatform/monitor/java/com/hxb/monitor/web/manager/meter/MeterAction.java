...
@Controller
@Scope("request")
public class MeterAction extends PageYMDActionSupport {
	...
	private String titleName = "当前位置：" 
			...
			+ "&gt;&gt;" 
			+ Config.getConfig("monitor.manager.2")
			+ "&gt;&gt;";
	@Autowired
	private MeterBusi busi;
	/**
	 * 查询条件-测控设备名称
	 */
	@PropertieType
...
//	@CheckPriv("-1")
	...
	public TbCsMeter getPo() {
		return po;
	}
	public void setPo(TbCsMeter po) {
		this.po = po;
	}
