...
<div class="margin">
          ...
          <div class="box_rela">
         	<table id="datas" class="easyui-datagrid" title="数据列表"
         		data-options="fitColumns:true,pagination:true,rownumbers:true,
         			singleSelect:true,checkOnSelect:false,selectOnCheck:false,remoteSort:false,height:364">
         		<thead>
         			<tr>
         				<th data-options="field:'ck',checkbox:true"></th>
         				<th data-options="field:'id',hidden:true,width:20">id</th>
         				<th data-options="field:'meterNm',sortable:true,align:'center',width:20">测控设备名称</th>
         				<th data-options="field:'meterId',sortable:true,align:'center',width:20">测控设备ID</th>
         				<th data-options="field:'online',sortable:true,align:'center',formatter:onlineHandler,width:20">在线状态</th>
         				<th data-options="field:'meterPro',align:'center',formatter:commandHandler,width:20">远程操作</th>
         			</tr>
         		</thead>
 ...
 <s:include value="cmds/cmds.jsp"></s:include>
</body>
</html>