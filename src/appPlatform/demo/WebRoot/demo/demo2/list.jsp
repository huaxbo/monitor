         	...
         	<table id="datas" class="easyui-datagrid" title="数据列表"
         		...
         		<thead>
         			<tr>
         				...
         				<th data-options="field:'cd',sortable:true,width:25">学号</th>
         				<th data-options="field:'name',sortable:true,width:25">姓名</th>
         				<th data-options="field:'age',sortable:true,width:25">年龄</th>
         			</tr>
         		</thead>
